  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Modern accounting software that helps small businesses manage their finances, 
            track expenses, create invoices, and stay compliant with tax requirements.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Create, send, and track professional invoices with ease</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Track and categorize business expenses automatically</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Connect your bank accounts for automatic transaction sync</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Bank-level security with tax compliance features</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Access your data anywhere with our mobile app</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of businesses using VeriGrade to streamline their finances
          </p>
          <Link 
            href="/register" 
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">VeriGrade</h3>
            <p className="text-gray-400 mb-4">
              Professional bookkeeping software for modern businesses
            </p>
